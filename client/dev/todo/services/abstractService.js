...
var AbstractService = (function () {
    function AbstractService(_http, route) {
        this._http = _http;
        this.route = '/api/todos/:id';
        this.route = route;
    }
    ...
    AbstractService.prototype.getElementById = function (id) {
        return this._http
            .get(this.route.replace(':id', id));
    };
    AbstractService.prototype.add = function (message) {
        var _messageStringified = JSON.stringify({ todoMessage: message });
        var headers = new http_1.Headers();
        headers.append('Content-Type', 'application/json');
        return this._http
            .post(this.route.replace(':id', ''), _messageStringified, { headers: headers })
            .map(function (r) { return r.json(); });
    };
